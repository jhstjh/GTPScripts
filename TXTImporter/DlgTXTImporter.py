...
# This script only support importing Dlg at the moment.
...
def main(argv):
    if len(sys.argv) <= 1:
        ...
        print('Usage: python DlgTXTImporter.py <TXTFilename>\n')
        return
